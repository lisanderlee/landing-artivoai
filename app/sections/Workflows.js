    ...
    <>
      <div className="relative bg-black">
        <div className="isolate overflow-visible">
          <div className="mx-auto flex max-w-[1300px] flex-col px-6 pb-24 sm:pb-32 lg:flex lg:px-8 lg:py-32">
            <div className="mb-36">
              <TitleSection
                title={t('flag')}
                color="white"
            ...
            <div className="flex flex-col gap-y-28">
              <WorkflowCard
                ...
                reverse={false}
                icon={<ArrowDownRight className="text-black" size={24} strokeWidth={2} />}
              />
              <WorkflowCard
                ...
                cta_secondary={t('cta_secondary')}
                reverse={true}
                icon={<Clapperboard className="text-black" size={24} strokeWidth={2} />}
              />
              <WorkflowCard
                ...
                cta_secondary={t('cta_secondary')}
                reverse={false}
                icon={<SquareUser className="text-black" size={24} strokeWidth={1.5} />}
              />
              <WorkflowCard
                ...
                cta_secondary={t('cta_secondary')}
                reverse={true}
                icon={<Clapperboard className="text-black" size={24} strokeWidth={1.5} />}
              />
              <WorkflowCard
                ...
                cta_secondary={t('cta_secondary')}
                reverse={true}
                icon={<Image className="text-black" size={24} strokeWidth={1.5} />}
              />
            </div>
          </div>
        </div>
